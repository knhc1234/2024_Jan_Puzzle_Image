...
class JigsawDataset(Dataset):
    ...
    def get_adjacency_matrix(self, order): 
    ...
    def get_score(self, order_true, order_pred): 
        ...
        for connect_type in connect_types:
            ...
            for connect_type_row in connect_type:
                ...
                if torch.equal(connect_bins[1:5], torch.LongTensor([0,1,0,1])): #  
                    piece_type.append(1)
                elif torch.equal(connect_bins[1:5], torch.LongTensor([0,1,1,1])): #
                    piece_type.append(2)
                elif torch.equal(connect_bins[1:5], torch.LongTensor([0,1,1,0])): #
                    piece_type.append(3)
                elif torch.equal(connect_bins[1:5], torch.LongTensor([1,1,0,1])): #
                    piece_type.append(4)
                elif torch.equal(connect_bins[1:5], torch.LongTensor([1,1,1,0])): #
                    piece_type.append(5)
                elif torch.equal(connect_bins[1:5], torch.LongTensor([1,0,0,1])): #
                    piece_type.append(6)
                elif torch.equal(connect_bins[1:5], torch.LongTensor([1,0,1,1])): #
                    piece_type.append(7)
...
trainer = L.Trainer(accelerator="gpu", max_epochs=300, precision='16-mixed', callbacks=[checkpoint_callback, earlystopping_callback])
